...
export interface TAlert<T = any> extends Omit<TAlertTableRecord, 'alertTypeId'>, TAlertsBufferRequired {
  // Наряду со свойством info_json, которое предназначено для сериализации и сохранения в БД,
  // в этом свойстве храним сущности, не предназначенные для сериализации. (Например, даты в представлении luxon)
  payload?: T,
}
